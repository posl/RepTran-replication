...
if __name__ == "__main__":
    ...
    for ds in ds_list:
        # Save destination directory (assumption)
                ...
                for fpfn in fpfn_list:
                    ...
                    for tgt_split in tgt_split_list:
                        ...
                        for reps_id in range(num_reps):
                            ...
                            # Record execution time when tgt_split is "repair"
                            if tgt_split == "repair":
                                t_repair_list.append(d.get("tot_time"))
                        # Calculate average of 5 runs
