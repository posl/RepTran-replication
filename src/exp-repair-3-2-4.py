...
if __name__ == "__main__":
    ...
    patch_filename = f"exp-repair-3-2-best_patch_{setting_id}_{fl_method}_reps{reps_id}.npy"
    ...
    if tgt_split == "repair":
        tgt_indices_filename = f"exp-repair-3-2-tgt_indices_{setting_id}_{fl_method}_reps{reps_id}.npy"
    ...
    if tgt_split == "repair":
        metrics_json_path = os.path.join(
            save_dir,
            f"exp-repair-3-2-metrics_for_repair_{setting_id}_{fl_method}_reps{reps_id}.json"
        )
        ...
        metrics_json_path = os.path.join(
            save_dir,
            f"exp-repair-3-2-metrics_for_{tgt_split}_{setting_id}_{fl_method}_reps{reps_id}.json"
        )
        metrics_dict = {}
    ...
    logger_obj.info("===== Completed exp-repair-3-2-5.py =====")
    print("===== Completed exp-repair-3-2-5.py =====")
