...
# Modified to use 3ranks x 3types instead of 5reps x 3ranks
...
for met_tag, (json_key, nice_name) in METRIC_INFO.items():
    ...
    for ds, split, wnum in itertools.product(DATASETS, SPLITS, WN_LIST):
        ...
        if ds == "c100" and wnum == 236 and split == "test":
            print(ds, wnum, "combined_ranks_types")
            show_flag = True
        else:
            show_flag = False
